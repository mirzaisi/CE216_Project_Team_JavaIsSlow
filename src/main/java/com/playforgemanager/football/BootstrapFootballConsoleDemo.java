...
public class BootstrapFootballConsoleDemo {
    ...
    private void simulateCurrentWeek(GameSession session, Ruleset ruleset) {
        League league = session.getCurrentSeason().getLeague();
    ...
    private BootstrapFootballLineup buildAutomaticLineup(Team team, Ruleset ruleset) {
    ...
    private void printStandingsTable(League league, Ruleset ruleset) {
