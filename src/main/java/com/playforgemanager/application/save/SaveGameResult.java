...
public record SaveGameResult(
    ...
    public SaveGameResult {
        // The result must always point to the file location that was saved.
        Objects.requireNonNull(savePath, "Save path cannot be null.");

        // Validates and cleans the save format information.
        ...
        // Stores the sport and controlled team connected to this save result.
        ...
        // Records when the save operation happened.
        Objects.requireNonNull(savedAt, "Saved timestamp cannot be null.");
    }
